export const VIDEO = {
  ABOUT:
    'https://cdn.jsdelivr.net/gh/Slim21211/long-academy-bot-media/about_company.mp4',
};
...
export const PDF_CATEGORIES = [
  {
    ...
    buttonText: 'Специалист по уходу стандарты работы',
    documents: [
      {
        id: 0,
  ...
  },
  {
    ...
    buttonText: 'Санитарка стандарты работы',
    documents: [
      {
        id: 2,
      ...
      {
        id: 5,
        name: 'Чек-лист по уборке входной группы_Санитарка',
  ...
  },
  {
    ...
    buttonText: 'Стандартные операционные процедуры (СОП)',
    documents: [
      {
        id: 1,
  ...
  {
    id: 'forbidden',
    title: 'Категорически запрещено персоналу пансионата',
    buttonText: 'Категорически запрещено персоналу пансионата',
    documents: [
      {
        id: 1,
...
export type PdfCategory = (typeof PDF_CATEGORIES)[number]['id'];
